...
from mainUserStoryFile import US02, US05, us03_birth_b4_death, us04_marr_b4_divorce, userstory1, userstory8, us06_div_b4_death, us07_age_lessthan_150, userstory09, userstory10, US15, US18,us16_male_last_name,us23_sameName_sameBirthDate,US22,US25
...
class TestContainer(unittest.TestCase):
    ...
    def test_US25(self):
        ...
        sf1 = {'@F1@': {'Married': '1990-06-15', 'Divorced': '1998-06-15', 'Husband Id': '@I1@','Husband Name': 'Smit /Nawar/', 'Wife Id': '@I2@', 'Wife Name': 'Smit /Nawar/', 'Children': {}}}
    ...
    def test_us16_male_last_name(self):
        ...
        si1 = {'@I4@': {'Name': 'Jack /Panchal/', 'Gender': 'M', 'Birthday': '1900-01-01', 'Death': '2000-08-01', 'FAMS': {1: '@F1@'}, 'FAMC': {1: '@I5@'}}}
        sf1 = {'@F1@': {'Married': '1990-06-15', 'Divorced': '2300-06-15', 'Husband Id': '@I1@',
                        'Husband Name': 'Smit /Nawar/', 'Wife Id': '@I2@', 'Wife Name': 'Yi Xie /Nawar/', 'Children': {1: '@I4@'}}}

        si2 = {'@I4@': {'Name': 'Smit /Nawar/', 'Gender': 'M', 'Birthday': '1900-01-01', 'Death': '2002-08-01', 'FAMS': {1: '@F1@'}, 'FAMC': {1: '@I5@'}}}
        sf2 = {'@F1@': {'Married': '1990-06-15', 'Divorced': '2001-06-15', 'Husband Id': '@I1@',
