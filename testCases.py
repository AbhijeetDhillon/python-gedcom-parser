...
class TestContainer(unittest.TestCase):
    ...
    def test_us28_sibilings_byAge(self):
        ...
        result = OrderedDict([('I4', {'Birthday': '1900-01-01', 'Name': 'Smitesh /Nawar/', 'Age': 120}), ('I6', {'Birthday': '1970-08-04', 'Name': 'Yiyesh /Nawar/', 'Age': 49}),
                              ('I7', {'Birthday': '1975-08-04', 'Name': 'YiXie /Nawar/', 'Age': 44}), ('I5', {'Birthday': '1978-08-04', 'Name': 'Yi Xieyesh /Nawar/', 'Age': 41})])
    ...
    def test_userstory35(self):
        ...
        print("\n\n Recent Birthdates")
        self.assertEqual(userstory35(si1), "FALSE")
    ...
    def test_userstory36(self):
        ...
        print("\n\n Recent Deaths")
        self.assertEqual(userstory36(si1), "FALSE")
