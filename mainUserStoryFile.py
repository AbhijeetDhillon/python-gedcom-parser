        ...
        for i1 in range(len(iid_arr)): 
            if i != i1: 
                if iid_arr[i] == iid_arr[i1]: 
                    # flagi = 1
                    print("ERROR: Individual: US22 :" + iid_arr[i1] + " id is not unique")
            # else:
            #     print(iid_arr[i1])
        ...
        for i1 in range(len(fid_arr)): 
            if i != i1: 
                if fid_arr[i] == fid_arr[i1]: 
                    # flagf = 1
                    print("ERROR: Family : US22 :" + fid_arr[i1] + " id is not unique")
            # else:
            #     print(fid_arr[i1])
...
def US25(i,f):
    ...
    for x in range(len(f.items())):
        ...
        if(not flag):
            print("ERROR: Family : US25 : " + fid_arr[x] + " doesn't have unique first names")
    return "True"
